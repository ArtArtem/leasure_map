...
def new_map(lon, lat, napr):
    ...
    if not response:
        print("Îøèáêà âûïîëíåíèÿ çàïğîñà")
        print(map_request)
    ...
    try:
        ...
        print("Îøèáêà çàïèñè âğåìåííîãî ôàéëà")
        sys.exit(2)
    return map_file
...
while gamer == False:
    ...
    if rect == 1:
        ...
        textsurface = myfont.render("ÌÓÇÅÉ ÈÇÎÁĞÀÇÈÒÅÏÜÍÜÆ", False, (0, 0, 0))
        ...
        textsurface2 = myfont2.render("22 ÀÂÃÓÑÒÀ - 27 ÑÅÍÒßÁĞß", False, (0, 0, 0))        
